function validate(event){
    ...
    if(!name || name == ""){
        ...
        nameG.innerHTML = "Valid ! Continue with email..."
        nameError =false;
    ...
    if(!email || email == ""){
        ...
        emailG.innerHTML = "Valid ! Continue with password..."
        emailError =false;
    ...
    if(!password || password == ""){
        ...
        PasswordG.innerHTML = "Valid ! Continue with password confirmation..."
    }
...
function validateEmail(email) {
  ...
  function validateName(name){
      var nameRegex = /^[a-zA-Z0-9_-\u00EB]{3,15}$/;
